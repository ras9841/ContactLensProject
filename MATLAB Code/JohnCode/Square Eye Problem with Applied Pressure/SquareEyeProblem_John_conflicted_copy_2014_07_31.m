...
sigma = 0.50; % sigma = 0.4998 works well

n = 100; % number of POINTS in x-direction and z-direction for both 
% variables u and w.
...
figure(1);
surf( u_sol ) % plot of u's solution
%shading interp;
...
figure(2);
surf( w_sol ) % plot of w's solution
